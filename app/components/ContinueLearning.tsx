    ...
    if (!course) {
        return (
            <section className="bg-slate-900/50 border border-slate-800 border-dashed rounded-3xl p-12 text-center">
                <h2 className="text-xl font-semibold text-white mb-2">No courses in progress</h2>
                <p className="text-slate-400 mb-6">Ready to level up your skills? Start your first lesson today.</p>
                <Link
                    to="/courses"
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                            <span className="text-slate-400 font-medium">{course.progress}% complete</span>
                            <span className="text-slate-500">{`${course.progress}/${course.lessonsCount}`} lessons</span>
                        </div>
