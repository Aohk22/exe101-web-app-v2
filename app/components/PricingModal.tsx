  ...
  const plans = [
    {
      ...
      features: ['Theory lessons', 'Free theory labs', 'Limited practical labs', 'Limited AI chat requests'],
    ...
    },
    {
      ...
      features: ['Unlimited learning path', 'Limited advanced labs', 'Private environments', 'Limited AI chat requests'],
    ...
    },
    {
      ...
      features: ['Unlimited advanced labs', 'Private environments', 'Unlimited AI Tutor access', 'Priority support'],
            ...
            <div className="grid lg:grid-cols-4 h-full">
              ...
              <div className="lg:col-span-1 bg-emerald-600 p-8 text-white flex flex-col justify-between relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl font-bold mb-4 leading-tight">Unlock Your Full Potential</h2>
                  <p className="text-emerald-100 text-sm">Join 50,000+ students already learning with Pro features.</p>
                </div>
                ...
                <div className="space-y-6 relative z-10 mt-8">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-sm">Unlimited Access</p>
                      <p className="text-[10px] text-emerald-100/80">Premium labs & paths</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-emerald-100/80">24/7 learning support</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-3 p-8 bg-slate-900">
                  ...
                  {plans.map((plan) => (
                    ...
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-slate-400 text-[10px] mt-1">{plan.description}</p>
                      </div>

                      <ul className="space-y-2 mb-6 flex-1">
                        {plan.features.map((feature) => (
                          <li key={feature} className="flex items-start gap-2 text-[11px] text-slate-300">
                            <Check className={`w-3 h-3 mt-0.5 shrink-0 ${plan.isPopular ? 'text-emerald-400' : 'text-slate-500'}`} />
                            <span>{feature}</span>
                          </li>
                        ))}
                      </ul>
                ...
                <div className="mt-6 text-center">
                  <p className="text-[10px] text-slate-500">
                    All plans include a 7-day money-back guarantee. <br />
