...
import { User, Mail, Bell, Shield, Moon, Globe, LogOut, Camera, Check, ChevronRight } from 'lucide-react';
            ...
            {activeTab === 'profile' && (
              <div className="space-y-8">
                ...
                <div className="pt-6 border-t border-slate-800 flex justify-end gap-4">
                  <button className="px-6 py-3 text-sm font-bold text-slate-400 hover:text-slate-200 transition-colors">Cancel</button>
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  {[
                    { id: 'email-reminders', title: 'Email Reminders', desc: 'Get notified about upcoming lessons and goals.' },
                    { id: 'course-updates', title: 'Course Updates', desc: 'Receive alerts when new content is added to your courses.' },
                    { id: 'achievements', title: 'Achievements', desc: 'Get notified when you earn a new badge or milestone.' },
                    { id: 'marketing', title: 'Marketing', desc: 'Receive news about new features and promotions.' },
                  ].map((item) => (
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-slate-800/50 rounded-3xl border border-slate-800 flex items-center justify-between">
                    ...
                    <button className="text-sm font-bold text-emerald-400 hover:text-emerald-300">Enable</button>
                  </div>

                  <div className="space-y-4">
                    <h4 className="font-bold text-white text-sm ml-1">Change Password</h4>
                    <div className="space-y-4">
                      <input 
                        type="password" 
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-2xl text-sm text-white focus:bg-slate-800 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all"
                      />
                      <button className="w-full py-3 bg-slate-100 text-black rounded-2xl text-sm font-bold hover:bg-white transition-all">Update Password</button>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between py-2">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-white text-sm">Language</h4>
