...
export default function Courses() {
  ...
  const categories = ['All', 'Offensive Security', 'Defensive Security', 'Forensics', 'Cloud Security', 'Compliance'];
    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-slate-400 mt-1">Find the perfect course to advance your career.</p>
        </div>
