    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-slate-200">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 mt-2 font-medium">Empowering your future, one lesson at a time.</p>
        </div>
        ...
        <div className="bg-slate-900 rounded-[1.75rem] shadow-2xl shadow-black/50 border border-slate-800 p-8 md:p-12">
          ...
          <Form method="POST" className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                <button type="button" className="text-xs font-bold text-emerald-400 hover:text-emerald-300 transition-colors">
                  Forgot Password?
                </button>
              </div>
              <div className="relative group">
            ...
            <div className="flex items-center gap-2 ml-1">
              <input type="checkbox" id="remember" className="w-4 h-4 rounded border-slate-700 bg-slate-800 text-emerald-600 focus:ring-emerald-500" />
          ...
          <div className="mt-8">
            <div className="relative flex items-center justify-center mb-8">
              ...
              <span className="relative px-4 bg-slate-900 text-xs font-bold text-slate-500 uppercase tracking-widest">Or continue with</span>
            </div>
